...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Categorie Bien</li>
                ...
                <div class="card-body">
                    ...
                    @if(!$parametres->isEmpty())
                        <div class="d-flex mb-3 justify-content-between">
                            <form action="{{ route('parameter_category.index') }}" method="GET" class="d-flex">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                @endif
                                                @if(Auth::user()->typeUser === 0 || Auth::user()->can('supprimer paramètres catégories'))
                                    ...
                                    <div class="modal fade" id="editParameterModal{{ $parametre->id }}" tabindex="-1" aria-labelledby="editParameterModalLabel{{ $parametre->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('parameter_category.update', $parametre->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="mb-3">
...
<div class="modal fade" id="createParameterModal" tabindex="-1" aria-labelledby="createParameterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('parameter_category.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
