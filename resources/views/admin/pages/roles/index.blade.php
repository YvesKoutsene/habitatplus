                            ...
                            <tr>
                                ...
                                <td>
                                    @if($role->permissions->isNotEmpty())
                                        @php $permissionsCount = $role->permissions->count(); @endphp
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="permissionsModalLabel-{{ $role->id }}">Permissions pour le rôle : {{ ucfirst($role->name) }}</h5>
