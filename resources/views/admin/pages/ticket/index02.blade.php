    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tickets Clôturés</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title">Liste des Tickets Clôturés</h5>
                        </div>
                        @if(!$tickets->isEmpty())
                            <div class="d-flex mb-3 justify-content-between">
                                <form action="{{ route('tckt.index02') }}" method="GET" class="d-flex">
                        ...
                        @if($tickets->isEmpty())
                            <div class="alert alert-info">
                                Aucun ticket clôturé pour le moment.
                            </div>
                        @else
